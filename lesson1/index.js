...
let cityName = 'Lutsk',
    cityCountry = 'Ukraine',
    cityPopulation = 217197,
    cityStadium = false,
    cityInfo = `${cityName} ${cityCountry} ${cityPopulation} ${cityStadium}`;
...
let time = 2,
    ...
    distanceBetween = (distanceOfFirst + distanceOfSecond);
    console.log (distanceBetween + 'км')
